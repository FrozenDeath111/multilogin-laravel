    ...
    <nav class="bg-white shadow-sm border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="text-xl font-bold text-indigo-600">Food Panda Site!</div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="px-6 py-3 text-xs font-semibold text-gray-600 uppercase">Delivary By</th>
                            <th class="px-6 py-3 text-xs font-semibold text-gray-600 uppercase">Shop</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100">
                        @forelse($orders as $order)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-sm font-bold text-gray-900">{{ $order['delivary_driver'] }}
                                </td>
                                <td class="px-6 py-4 text-sm font-bold text-gray-900">{{ $order['shop_name'] }}
                                </td>
                            </tr>
                        @empty
                            <tr>
